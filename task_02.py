...
def get_numbers_tickets(min, max, quantity):
    ...
    # додаємо обробку виключення для випадку вводу невірних даних
    try:    
    ...
    # Виводимо попередження якщо кількість відбору вища за кількість чисел у списку
        ...
        print(f"Quantity of numbers must be less or equal then the largest number in the range")

print(get_numbers_tickets(1, 100, 1000))